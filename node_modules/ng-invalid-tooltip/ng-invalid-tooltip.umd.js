(function (global, factory) {
	...
	(factory((global['ng-invalid-tooltip'] = {}),global.core,global.common,global.forms));
    ...
    InvalidTooltipDirective.prototype._addTooltip = function (message) {
        this._componentRef =
            this._componentFactoryResolver.resolveComponentFactory(TooltipComponent)
                .create(core.ReflectiveInjector.resolveAndCreate([], this._applicationRef.components[0].injector));
...
InvalidTooltipDirective.propDecorators = {
    'errorMaps': [{ type: core.Input, args: ['invalidTooltip',] },],
...
exports.InvalidTooltipModule = InvalidTooltipModule;
exports.InvalidTooltipDirective = InvalidTooltipDirective;
